            ...
            <div key={list.id} id="slider" className="sm:pr-20 pr-10">
                <div className="video-carousel_container">
                    <div className="w-full h-full flex-center rounded-3xl overflow-hidden bg-black">
                        <video id="video" muted className={`${list.id === 2 && 'translate-x-44'} pointer-events-none`} playsInline={true} preload="auto" ref={((el) => {videoRef.current[i]=el})} onEnded={ () => {i !==3 ? handleProcess("video-end",i) : handleProcess("video-last")}} onPlay={() =>
                            setVideo((prevVideo) => ({
